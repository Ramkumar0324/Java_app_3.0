...
def jfrogUpload() :
    ...
    url = 'http://3.236.78.180::8082/artifactory/example-repo-local/kubernetes-configmap-reload-0.0.1-SNAPSHOT.jar'
    file_path = '/var/lib/jenkins/workspace/java-3.0/target/kubernetes-configmap-reload-0.0.1-SNAPSHOT.jar'
    username = 'admin'
    password = 'Admin@12345' #replace 'your password with ur actual password'
